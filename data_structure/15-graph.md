...
[정의] Spanning Tree는 Acyclic Connected Subgraph of G that contains all of G's vertices. 

> edge를 **|V|-1** 개만 남김. 사실 tree with n vertices는 항상 n-1 edges

- **DFS Spanning Trees** / **BFS Spanning Trees**

- **Minimum Spanning Trees**

  : weighted graph에서 edge의 **weight의 합이 가장 작은** spanning tree
